function [nodeid_lft, nodeid_rght, nodeid_wlcond] = lse_find_port_nodes(all_panel_locs, all_panels_ids, grid_intcon, L, M, N, dx, pnt_lft, pnt_rght, pnt_well_cond, fl_check_ports)
