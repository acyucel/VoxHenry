function [pnt_found,pnt_id] = lse_find_nodeid(all_panel_locs,all_panels_ids,pnt_coor,num_nonair_cube,tola,fl_vis_exc_grnd,dum)
...
elseif ( abs(all_panel_locs(num_nonair_cube+dum,1)-pnt_coor(1)) < tola && ...
    ...
    pnt_id=all_panels_ids(num_nonair_cube+dum,1);
    % plot the point
    if(fl_vis_exc_grnd == 1)
        hold on
        ...
        hold on
        h=text(all_panel_locs(num_nonair_cube+dum,1),all_panel_locs(num_nonair_cube+dum,2),all_panel_locs(num_nonair_cube+dum,3),num2str(all_panels_ids(num_nonair_cube+dum,1)));set(h,'FontSize',24);
    end
    pnt_found=1;
    return
...
elseif ( abs(all_panel_locs(num_nonair_cube+dum,4)-pnt_coor(1)) < tola && ...
    ...
    pnt_id=all_panels_ids(num_nonair_cube+dum,2);
    % plot the point
    if(fl_vis_exc_grnd == 1)
        hold on
        ...
        hold on
        h=text(all_panel_locs(num_nonair_cube+dum,4),all_panel_locs(num_nonair_cube+dum,5),all_panel_locs(num_nonair_cube+dum,6),num2str(all_panels_ids(num_nonair_cube+dum,2)));set(h,'FontSize',24);
    end
...
elseif ( abs(all_panel_locs(2*num_nonair_cube+dum,1)-pnt_coor(1)) < tola && ...
    ...
    pnt_id=all_panels_ids(2*num_nonair_cube+dum,1);
    % plot the point
    if(fl_vis_exc_grnd == 1)
        hold on
        ...
        hold on
        h=text(all_panel_locs(2*num_nonair_cube+dum,1),all_panel_locs(2*num_nonair_cube+dum,2),all_panel_locs(2*num_nonair_cube+dum,3),num2str(all_panels_ids(2*num_nonair_cube+dum,1)));set(h,'FontSize',24);
    end
    pnt_found=1;
    return
...
elseif ( abs(all_panel_locs(2*num_nonair_cube+dum,4)-pnt_coor(1)) < tola && ...
    ...
    pnt_id=all_panels_ids(2*num_nonair_cube+dum,2);
    % plot the point
    if(fl_vis_exc_grnd == 1)
        hold on
        ...
        hold on
        h=text(all_panel_locs(2*num_nonair_cube+dum,4),all_panel_locs(2*num_nonair_cube+dum,5),all_panel_locs(2*num_nonair_cube+dum,6),num2str(all_panels_ids(2*num_nonair_cube+dum,2)));set(h,'FontSize',24);
    end
