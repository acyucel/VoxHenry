...
inner_it = 100; outer_it = 10; tol=1e-6; % iterative solver inputs
...
% R+jL matrices
save('results_numex3_circular_coil/data_R_jL_mat.mat', 'num_freq', 'num_ports','freq_all','R_jL_mat');

% CPU timings
save('results_numex3_circular_coil/data_CPU_timings.mat', 'num_freq', 'num_ports','sim_CPU_pre','sim_CPU_lse');

% CPU timings
save('results_numex3_circular_coil/data_curr_plot.mat', 'x', 'Ae_only_leaving','Ae_only_entering_bndry','r','Mc','dx','plot_option');
