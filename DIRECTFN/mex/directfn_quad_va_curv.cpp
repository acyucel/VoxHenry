...
{  
  ...
  double* r16 = mxGetPr(prhs[15]);
  double* r17 = mxGetPr(prhs[16]);
    
  int N1 = (int)mxGetScalar(prhs[17]);  
  int N2 = (int)mxGetScalar(prhs[18]);
  int N3 = (int)mxGetScalar(prhs[19]);
  int N4 = (int)mxGetScalar(prhs[20]);

  double k0 = mxGetScalar(prhs[21]);

  const string btt_type = mxArrayToString(prhs[22]);
  int len;
  int status = -1;
  ...
  if (btt_type == string("Constant")) {
	  ...
	  status = directfn_quad_va_curv<QuadrilateralKernel_CurvilinearScalar>(r1, r2, r3, r4, r5, r6, r7,
		  r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, N1, N2, N3, N4, k0, I_DE.get());
  } else if (btt_type == string("Vector_WS")) {
	  len = QuadrilateralKernel_CurvilinearVectorWS::constexpr_size();
	  I_DE.reset(new dcomplex[len]);
	  status = directfn_quad_va_curv<QuadrilateralKernel_CurvilinearVectorWS>(r1, r2, r3, r4, r5, r6, 
		  r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, N1, N2, N3, N4, k0, I_DE.get());
  } else if (btt_type == string("Vector_SS")) {
	  len = QuadrilateralKernel_CurvilinearVectorSS::constexpr_size();
	  I_DE.reset(new dcomplex[len]);
	  status = directfn_quad_va_curv<QuadrilateralKernel_CurvilinearVectorSS>(r1, r2, r3, r4, r5, r6, 
		  r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, N1, N2, N3, N4, k0, I_DE.get());
  }
