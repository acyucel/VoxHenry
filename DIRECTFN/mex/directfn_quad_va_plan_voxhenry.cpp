...
{  
  ...
  int integral_type = (int)mxGetScalar(prhs[18]);
  int volume_ker = (int)mxGetScalar(prhs[19]);
  ...
  if (volume_ker == 2) {
    if (kernel_type == 1) {
	  status = directfn_quad_va_plan_voxhenry<QuadKer_PlanVH_VolKer2_KerTyp1>(r1, r2, r3, r4, r5, r6, r7, N1, N2, N3, N4, k0, nq, np, integral_type, I_DE.get());
    }
    else if (kernel_type == 2) {
	  status = directfn_quad_va_plan_voxhenry<QuadKer_PlanVH_VolKer2_KerTyp2>(r1, r2, r3, r4, r5, r6, r7, N1, N2, N3, N4, k0, nq, np, integral_type, I_DE.get());
    }
    else if (kernel_type == 3) {
	  status = directfn_quad_va_plan_voxhenry<QuadKer_PlanVH_VolKer2_KerTyp3>(r1, r2, r3, r4, r5, r6, r7, N1, N2, N3, N4, k0, nq, np, integral_type, I_DE.get());
    }
    else if (kernel_type == 4) {
	  status = directfn_quad_va_plan_voxhenry<QuadKer_PlanVH_VolKer2_KerTyp4>(r1, r2, r3, r4, r5, r6, r7, N1, N2, N3, N4, k0, nq, np, integral_type, I_DE.get());
    }
    else mexErrMsgTxt("Wrong kernel_type parameter!");
  }
  else if (volume_ker == 3) {
    if (kernel_type == 1) {
	  status = directfn_quad_va_plan_voxhenry<QuadKer_PlanVH_VolKer3_KerTyp1>(r1, r2, r3, r4, r5, r6, r7, N1, N2, N3, N4, k0, nq, np, integral_type, I_DE.get());
    }
    else if (kernel_type == 2) {
	  status = directfn_quad_va_plan_voxhenry<QuadKer_PlanVH_VolKer3_KerTyp2>(r1, r2, r3, r4, r5, r6, r7, N1, N2, N3, N4, k0, nq, np, integral_type, I_DE.get());
    }
    else if (kernel_type == 3) {
	  status = directfn_quad_va_plan_voxhenry<QuadKer_PlanVH_VolKer3_KerTyp3>(r1, r2, r3, r4, r5, r6, r7, N1, N2, N3, N4, k0, nq, np, integral_type, I_DE.get());
    }
    else if (kernel_type == 4) {
	  status = directfn_quad_va_plan_voxhenry<QuadKer_PlanVH_VolKer3_KerTyp4>(r1, r2, r3, r4, r5, r6, r7, N1, N2, N3, N4, k0, nq, np, integral_type, I_DE.get());
    }
    else mexErrMsgTxt("Wrong kernel_type parameter!");
  }
